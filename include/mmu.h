...
/*
 * Part 1.  RV64 definitions.
 */
#define MODE_BARE	0
#define MODE_SV39	8
#define MODE_SV48	9

#define BY2PG		((u_int64_t)4096)	// bytes to a page
#define PDMAP		(4*1024*1024)	// bytes mapped by a page directory entry
#define PGSHIFT		12
#define PDSHIFT		22		// log2(PDMAP)
#define PDX(va)		((((u_int64_t)(va))>>22) & 0x03FF)
#define PTX(va)		((((u_int64_t)(va))>>12) & 0x03FF)
#define PTE_ADDR(pte)	((u_int64_t)(pte)&~0x1FF)

#define VPT1MAP		(BY2PG * 512)
#define VPT2MAP		(VPT1 * 512)
#define PT0SHIFT	PGSHIFT
#define PT1SHIFT	(PT0SHIFT + 9)
#define PT2SHIFT	(PT1SHIFT + 9)
#define VPN2(va)	((((u_int64_t)(va)) >> PT2SHIFT) & 0x01FF)
#define VPN1(va)	((((u_int64_t)(va)) >> PT1SHIFT) & 0x01FF)
#define VPN0(va)	((((u_int64_t)(va)) >> PT0SHIFT) & 0x01FF)
#define PTE_TO_PADDR(pte)	((((u_int64_t)(pte)) & 0x003FFFFFFFFFFC00) << 2)
#define PADDR_TO_PTE(pa)	((((u_int64_t)(pa)) >> 2) & 0x003FFFFFFFFFFC00)

// page number field of address
#define PPN(va)		(((u_int64_t)(va))>>12)
